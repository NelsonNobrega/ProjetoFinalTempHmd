...
async function main() {
  ...
  const url = `https:c-link">ตรวจพบฟิชชิง</a>ใน $1 เว็บไซต์ฟิชชิงปลอมเป็นเว็บไซต์อื่นๆ เพื่อหลอกคุณคุณสามารถ<a href="#" id="report-error-link">รายงานปัญหาในการตรวจหา</a>ได้ หรือหากคุณเข้าใจถึงความเสี่ยงต่อความปลอดภัยของคุณ คุณสามารถ<a href="#" id="proceed-link">เข้าชมเว็บไซต์ที่ไม่ปลอดภัย</a>ได้ผู้โจมตีเว็บไซต์ที่คุณพยายามเข้าชมอาจหลอกล่อให้คุณติดตั้งซอฟต์แวร์หรือเปิดเผยข้อมูล เช่น รหัสผ่าน หมายเลขบัตรเครดิต หรือหมายเลขโทรศัพท์ Chrome ขอแนะนำเป็นอย่างยิ่งให้กลับสู่ความปลอดภัย <a href="#" id="learn-more-link">ดูข้อมูลเพิ่มเติม</a>Chrome มีฟีเจอร์ความปลอดภัยในตัวเพื่อปกป้องคุณขณะท่องเว็บ เช่น Google Safe Browsing ที่<a href="#" id="diagnostic-link">พบฟิชชิง</a>ในเว็บไซต์ที่คุณพยายามเข้าชมเมื่อเร็วๆ นี้ เว็บไซต์ฟิชชิงปลอมเป็นเว็บไซต์อื่นๆ เพื่อหลอกคุณ<br/><br/>บางครั้งเว็บไซต์ที่โดยปกติจะปลอดภัยก็อาจถูกบุกรุกจากผู้โจมตีได้ โปรด<a href="#" id="report-error-link">แจ้งให้เราทราบ</a>หากคุณคิดว่ามีข้อผิดพลาดเกิดขึ้นและเว็บไซต์นี้ไม่ก่อให้เกิดอันตรายChrome มีฟีเจอร์ความปลอดภัยในตัวเพื่อปกป้องคุณขณะท่องเว็บ เช่น Google Safe Browsing เมื่อเร็วๆ นี้ Google Safe Browsing <a href="#" id="diagnostic-link">พบฟิชชิงใน $1</a> ที่ฝังอยู่ในเว็บไซต์ที่คุณพยายามเข้าชม<br/><br/>บางครั้งเว็บไซต์ที่โดยปกติจะปลอดภัยก็อาจถูกบุกรุกจากผู้โจมตีได้ โปรด<a href="#" id="report-error-link">แจ้งให้เราทราบ</a>หากคุณคิดว่ามีข้อผิดพลาดเกิดขึ้นและเว็บไซต์นี้ไม่ก่อให้เกิดอันตรายโปรดเข้าชม<a href="#" id="proceed-link">เว็บไซต์ที่ไม่ปลอดภัยนี้</a>ต่อเมื่อคุณมั่นใจว่าเข้าใจถึงความเสี่ยงแล้วเท่านั้นบล็อกเนื้อหาอันตรายแล้วเนื้อหานี้อาจพยายามติดตั้งซอฟต์แวร์อันตรายที่จะขโมยหรือลบข้อมูลในอุปกรณ์ของคุณ <a href="#" id="proceed-link">แสดงเนื้อหา</a>บล็อกเนื้อหาที่หลอกลวงแล้วเนื้อหานี้อาจพยายามหลอกล่อให้คุณติดตั้งซอฟต์แวร์หรือเปิดเผยข้อมูลส่วนบุคคล <a href="#" id="proceed-link">แสดงเนื้อหา</a>เนื้อหานี้อาจพยายามติดตั้งแอปที่หลอกลวงซึ่งปลอมเป็นเนื้อหาอย่างอื่นหรือรวบรวมข้อมูลที่อาจนำไปใช้ติดตามคุณ <a href="#" id="proceed-link">แสดงเนื้อหา</a>อาจมีการเรียกเก็บเงินการเรียกเก็บเงินเหล่านี้อาจเกิดขึ้นครั้งเดียวหรือเกิดขึ้นซ้ำๆ และอาจไม่แสดงอย่างชัดแจ้ง <a href="#" id="proceed-link">เปิดเว็บไซต์</a>ความช่วยเหลือในการเชื่อมต่อแก้ไขข้อผิดพลาดในการเชื่อมต่อ<p>หากคุณพยายามเข้าชมเว็บไซต์ แต่เว็บไซต์ไม่เปิดขึ้นมา ให้ลองแก้ข้อผิดพลาดด้วยขั้นตอนการแก้ปัญหาต่อไปนี้</p>
    <ol>
    ...
    </ol>ขอความช่วยเหลือเกี่ยวกับข้อความแสดงข้อผิดพลาดที่เจาะจง"การเชื่อมต่อของคุณไม่เป็นส่วนตัว" หรือ "<span class="error-code">NET::ERR_CERT_AUTHORITY_INVALID</span>" หรือ "<span class="error-code">ERR_CERT_COMMON_NAME_INVALID</span>" หรือ "<span class="error-code">NET::ERR_CERT_WEAK_SIGNATURE_ALGORITHM</span>" หรือ "<span class="error-code">ERR_CERT_SYMANTEC_LEGACY</span>" หรือ "ข้อผิดพลาดของใบรับรอง SSL""เชื่อมต่อกับเครือข่าย""นาฬิกาของคุณช้ากว่าปัจจุบัน" หรือ "นาฬิกาของคุณเร็วกว่าปัจจุบัน" หรือ "<span class="error-code">NET::ERR_CERT_DATE_INVALID</span>"<h4>ขั้นตอนที่ 1: ลงชื่อเข้าใช้พอร์ทัล</h4>
    ...
    <p>เปิดหน้าเว็บที่คุณได้เข้าชมในหน้าต่างที่ไม่ระบุตัวตน</equirements are needed:
