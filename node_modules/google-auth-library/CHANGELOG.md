อไปนี้ซึ่งไม่ได้แสดงอยู่ใน $1 และอาจมีการเพิ่มเข้ามาโดยที่คุณไม่รู้ตัวปรับแต่งและควบคุม Chromium มีการอัปเดตปรับแต่งและควบคุม Chromium มีสิ่งที่คุณจำเป็นต้องทราบ โปรดคลิกเพื่อดูรายละเอียด&เปิดใน Chromiumเกี่ยวกับ &Chromiumเปิดอีกครั้งเพื่ออัปเดต Chromiumคุณเคยลงชื่อเข้าใช้ Chromium ในชื่อ $1 โปรดใช้บัญชีเดิมเพื่อลงชื่อเข้าใช้อีกครั้งก่อนหน้านี้มีผู้ลงชื่อเข้าใช้ Chromium ในคอมพิวเตอร์นี้ด้วยชื่อ $1 โปรดสร้างผู้ใช้ Chromium ใหม่เพื่อเก็บข้อมูลแยกเชื่อมโยงข้อมูล Chromium กับบัญชีนี้ไหมคุณกำลังลงชื่อเข้าใช้ด้วยบัญชีที่จัดการ และให้การควบคุมระดับผู้ดูแลระบบของบัญชีดังกล่าวเหนือโปรไฟล์ Chromium ของคุณ ข้อมูล Chromium เช่น แอป บุ๊กมาร์ก ประวัติการเข้าชม รหัสผ่าน และการตั้งค่าอื่นๆ จะเชื่อมโยงอย่างถาวรกับ $1 คุณจะสามารถลบข้อมูลนี้ผ่านทางแผงควบคุมบัญชี Google แต่คุณจะไม่สามารถเชื่อมโยงข้อมูลนี้กับบัญชีอื่น $2คุณกำลังลงชื่อเข้าใช้ด้วยบัญชีที่จัดการ และให้การควบคุมระดับผู้ดูแลระบบของบัญชีดังกล่าวเหนือโปรไฟล์ Chromium ของคุณ ข้อมูล Chromium เช่น แอป บุ๊กมาร์ก ประวัติการเข้าชม รหัสผ่าน และการตั้งค่าอื่นๆ จะเชื่อมโยงอย่างถาวรกับ $1 คุณจะสามารถลบข้อมูลนี้ผ่านทางแผงควบคุมบัญชี Google แต่คุณจะไม่สามารถเชื่อมโยงข้อมูลนี้กับบัญชีอื่น คุณสามารถเลือกที่จะสร้างโปรไฟล์ใหม่เพื่อแยกเก็บข้อมูล Chromium ที่มีอยู่ของคุณ $2เพิ่มโปรไฟล์งานลงในเบราว์เซอร์นี้คุณกำลังเพิ่มโปรไฟล์งานลงในเบราว์เซอร์นี้และให้ผู้ดูแลระบบเป็นผู้ควบคุมเฉพาะโปรไฟล์งานดังกล่าวโปรไฟล์งานนี้แยกออกจากโปรไฟล์ส่วนตัวโดยสิ้นเชิงผู้ดูแลโปรไฟล์งานนำข้อมูล Chromium ที่สร้างขึ้นในช่วงที่มีการใช้โปรไฟล์นี้ออกได้ (เช่น การสร้างบุ๊กมาร์ก ประวัติการเข้าชม รหัสผ่าน และการตั้งค่าอื่นๆ) $1คุณลงชื่อเข้าใช้ Chromium แล้ว!คุณกำลังลงชื่อเข้าใช้เป็น $1 ตอนนี้คุณสามารถเข้าถึงบุ๊กมาร์ก ประวัติการเข้าชม และการตั้งค่าอื่นๆ บนอุปกรณ์ทั้งหมดที่ลงชื่อเข้าใช้ผู้ดูแลระบบของคุณกำหนดค่าให้ Chromium เปิดเบราว์เซอร์สำรองเพื่อเข้าถึง $1ผู้ดูแลระบบได้กำหนดค่าให้ Chromium เปิด $2 เพื่อเข้าถึง $1$1 ใช้ Chromium อยู่ก่อนหน้านี้ดำเนินการต่อในโปรไฟล์ Chromium ใหม่ไหมเปลี่ยนไปใช้โปรไฟล์ Chromium ที่มีอยู่ไหมมีโปรไฟล์ Chromium ที่ใช้บัญชีนี้อยู่แล้ว$1 ลงชื่อเข้าใช้โปรไฟล์ Chromium นี้แล้ว หากต้องการแยกการท่องเว็บของคุณไว้ต่างหาก Chromium สร้างโปรไฟล์ให้คุณโดยเฉพาะได้$1 ลงชื่อเข้าใช้โปรไฟล์ Chromium นี้แล้ว การดำเนินการนี้จะสร้างโปรไฟล์ Chromium ใหม่สำหรับ $2การดำเนินการนี้จะสร้างโปรไฟล์ Chromium ใหม่สำหรับ $1บัญชีอื่นได้ลงชื่อเข้าใช้อยู่แล้ว หากต้องการแยกการท่องเว็บของคุณไว้ต่างหาก Chromium สร้างโปรไฟล์ให้คุณโดยเฉพาะได้ปรับเปลี่ยน Chromium ในแบบของคุณลงชื่อเข้าใช้เพื่อรับประโยชน์สูงสุดจาก Chromiumใช้ Chromium โดยไม่มีบัญชีลงชื่อเข้าใช้ Chromium ไหมปรับแต่งโปรไฟล์ Chromium ใหม่แอป ChromiumChromium ใช้กล้องและไมโครโฟนของคุณอยู่Chromium ใช้ไมโครโฟนของคุณอยู่Chromium ใช้กล้องของคุณอยู่{NUM_DEVICES,plural, =0{มีส่วนขยาย Chromium อย่างน้อย 1 รายการกำลังเข้าถึงอุปกรณ์ HID 1 เครื่อง}=1{มีส่วนขยาย Chromium อย่างน้อย 1 รายการกำลังเข้าถึงอุปกรณ์ HID 1 เครื่อง}other{มีส่วนขยาย Chromium อย่างน้อย 1 รายการกำลังเข้าถึงอุปกรณ์ HID # เครื่อง}}{NUM_DEVICES,plural, =0{มีส่วนขยาย Chromium อย่างน้อย 1 รายการกำลังเข้าถึงอุปกรณ์ USB 1 เครื่อง}=1{มีส่วนขยาย Chromium อย่างน้อย 1 รายการกำลังเข้าถึงอุปกรณ์ USB 1 เครื่อง}other{มีส่วนขยาย Chromium อย่างน้อย 1 รายการกำลังเข้าถึงอุปกรณ์ USB # เครื่อง}}ระบบจะลบข้อมูลการท่องเว็บของบุคคลนี้ออกจากอุ�.6.0](https://github.com/googleapis/google-auth-library-nodejs/compare/v9.5.0...v9.6.0) (2024-01-29)
